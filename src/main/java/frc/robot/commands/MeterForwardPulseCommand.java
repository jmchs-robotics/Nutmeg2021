...
public class MeterForwardPulseCommand extends CommandBase {
   ...
   */
  public MeterForwardPulseCommand(MeterSubsystem meter) {
  ...
  public void initialize() {
    m_timer.reset();
    m_timer.start();
    m_time = m_meter.getForwardPulse();
  }
  ...
  public void execute() {
     ...
     */
    m_meter.setMotor(m_meter.getForwardSpeed());
  }
